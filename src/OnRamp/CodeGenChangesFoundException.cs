...
namespace OnRamp
{
    ...
    /// </summary>
    /// <remarks>Raised where the code-generation would result in changes to an underlying artefact. This is managed by setting <see cref="ICodeGeneratorArgs.ExpectNoChanges"/> to <c>true</c>.</remarks>
