...
namespace OnRamp.Generators
{
    ...
    public abstract class CodeGeneratorBase<TRootConfig, TGenConfig> : CodeGeneratorBase where TRootConfig : ConfigBase where TGenConfig : ConfigBase
    {
        ...
        /// </summary>
        /// <param name="script">The <see cref="CodeGenScriptItem"/>.</param>
        ...
        public override void Generate(CodeGenScriptItem script, ConfigBase config, Action<CodeGenOutputArgs> artefactGenerated) => Generate(script, (TRootConfig)config, artefactGenerated);
        ...
        /// <param name="config">The root <see cref="ConfigBase"/>.</param>
        /// <param name="artefactGenerated">The <see cref="Action{T}"/> to invoked per artefact generated to be output.</param>
        public void Generate(CodeGenScriptItem script, TRootConfig config, Action<CodeGenOutputArgs> artefactGenerated)
        {
            if (script == null)
